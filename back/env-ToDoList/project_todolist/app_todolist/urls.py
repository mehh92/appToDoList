...
from .views import (
    get_utilisateurs, get_utilisateur, create_utilisateur, update_utilisateur, delete_utilisateur,
    get_todolists, get_todolist, create_todolist, update_todolist, delete_todolist,
    get_taches, get_tache, create_tache, update_tache, delete_tache,
    get_suggestions, get_suggestion, create_suggestion, update_suggestion, delete_suggestion
)
